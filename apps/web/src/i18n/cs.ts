...
export const cs: Record<string, string> = {
  ...
  // Ticket modal
  "tm.section.parent": "Nadřazený ticket",
  "tm.section.description": "Popis",
  "tm.section.triage_notes": "Triage poznámky",
  "tm.section.subtasks": "Subtickety ({done}/{total} hotovo)",
  "tm.section.runs": "Běhy ({count})",
  "tm.section.active_run": "Aktivní běh",
  "tm.side.status": "Status",
  "tm.side.priority": "Priorita",
  "tm.side.workflow": "Workflow",
  "tm.side.folders": "Repos",
  "tm.side.folders_empty": "(žádné repos v projektu)",
  "tm.side.depends_on": "Závisí na ({count})",
  "tm.side.workflow_unset": "(nastaví Triage)",
  "tm.body.empty": "(prázdné — klikni pro úpravu)",
  "tm.body.placeholder": "(prázdné)",
  "tm.btn.edit": "Upravit",
  "tm.btn.triage": "Triage",
  "tm.btn.retriage": "Re-triage",
  "tm.btn.decompose": "Rozdělit",
  "tm.btn.start_run": "▶ Spustit běh",
  "tm.btn.start_run_disabled": "Přidej repo nebo počkej na dokončení aktivního běhu",
  "tm.btn.triage_title": "Spustit Triage agenta (priorita, repos, workflow)",
  "tm.btn.decompose_title": "Spustit CTO — rozdělí ticket na subtickety",
  "tm.confirm.delete_with_runs": "Smazat ticket? Smaže se {count} běh(ů) a jejich worktrees.",
  "tm.confirm.delete": "Smazat ticket?",
  "tm.run.cost": "${cost}",
