...
export const en: Record<string, string> = {
  ...
  // Ticket modal
  "tm.section.parent": "Parent",
  "tm.section.description": "Description",
  "tm.section.triage_notes": "Triage notes",
  "tm.section.subtasks": "Subtasks ({done}/{total} done)",
  "tm.section.runs": "Runs ({count})",
  "tm.section.active_run": "Active run",
  "tm.side.status": "Status",
  "tm.side.priority": "Priority",
  "tm.side.workflow": "Workflow",
  "tm.side.folders": "Repos",
  "tm.side.folders_empty": "(no repos in project)",
  "tm.side.depends_on": "Depends on ({count})",
  "tm.side.workflow_unset": "(set by Triage)",
  "tm.body.empty": "(empty — click to add)",
  "tm.body.placeholder": "(empty)",
  "tm.btn.edit": "Edit",
  "tm.btn.triage": "Triage",
  "tm.btn.retriage": "Re-triage",
  "tm.btn.decompose": "Decompose",
  "tm.btn.start_run": "▶ Start run",
  "tm.btn.start_run_disabled": "Add a repo or wait for the active run to finish",
  "tm.btn.triage_title": "Run Triage agent (priority, repos, workflow)",
  "tm.btn.decompose_title": "Run CTO to split into subtasks",
  "tm.confirm.delete_with_runs": "Delete this ticket? {count} run(s) and their worktrees will be removed.",
  "tm.confirm.delete": "Delete this ticket?",
  "tm.run.cost": "${cost}",
